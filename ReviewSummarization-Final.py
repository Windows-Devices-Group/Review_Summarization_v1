...
if device_name:
        with st.form(key='my_form'):
            selected_geo = st.selectbox('Select a geography from where you need summarized consumer reviews:', geo_names)
            selected_aspect = st.selectbox('Select an aspect to see summarized consumer reviews:', aspect_names)
